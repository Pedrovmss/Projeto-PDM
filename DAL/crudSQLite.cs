...
namespace appProvaA1Enfermeiro.DAL
{
    /*
    ...
    public class crudSQLite
    {
         ...
         * e ler dados das enfermeiros cadastradas.
         */
        ...
        public crudSQLite(string path)
        {
            ...
            /*
             * Criação da tabela com base no Model Enfermeiro (mais detalhes no arquivo Enfermeiro.cs na pasta Model)
             ...
             * insert.
             */
            _conexao.CreateTableAsync<Enfermeiro>().Wait();
        }
        /*
         ...
         */
        public Task<int> Insert(Enfermeiro enfermeiro1)
        {
            return _conexao.InsertAsync(enfermeiro1);
        }
        /*
         ...
         */
        public Task<List<Enfermeiro>> Update(Enfermeiro enfermeiro1)
        {
            string sql = "UPDATE Enfermeiro SET enfNome=?, enfEspecialidade=? WHERE enfID=? ";
            return _conexao.QueryAsync<Enfermeiro>(sql, enfermeiro1.enfNome, enfermeiro1.enfEspecialidade, enfermeiro1.enfID);
        }
        /*
         * Método que faz o retorno de todas as linhas contidas no arquivo db3 referentes 
         * a tabela Enfermeiro. Veja que o método executa a listagem de forma assíncrona.
         */
        public Task<List<Enfermeiro>> GetAll()
        {
            return _conexao.Table<Enfermeiro>().ToListAsync();
        }
        /*
         * Método que remove um registro do arquivo db3 de forma assíncrona. Este método recebe
         * como parâmetro o campo enfID do registro a ser removido. Observe o uso da LINQ no processo de
         * remoção.
         */
        public Task<int> Delete(int idPes)
        {
            return _conexao.Table<Enfermeiro>().DeleteAsync(i => i.enfID == idPes);
        }
        /*
         ...
         * É retornada uma Lista de Enfermeiros por meio de uma Task. A execução do SQL segue a mesma
         * linha utilizada no método update.
         */
        public Task<List<Enfermeiro>> Search(string buscaPesssoa)
        {
            string sql = "SELECT * FROM Enfermeiro WHERE enfNome LIKE '%" + buscaPesssoa + "%' ";

            return _conexao.QueryAsync<Enfermeiro>(sql);
        }
    }
}